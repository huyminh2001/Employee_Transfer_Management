...
public class JDialogViewRecordLocation extends JDialog {
	...
	public JDialogViewRecordLocation() {
		...
		{
			JLabel lblNewLabel = new JLabel("View Location Record");
	 ...
	 */
	public JDialogViewRecordLocation(Map<String, Object> dataRecord, Map<String, Object> data) {
		this();
