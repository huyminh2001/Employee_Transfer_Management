...
public class JDialogViewRecordProject extends JDialog {
	 ...
	 */
	public JDialogViewRecordProject() {
		...
		{
			JLabel lblNewLabel = new JLabel("View Project Record");
	...
	public JDialogViewRecordProject(Map<String, Object> dataRecord, Map<String, Object> data) {
		this();
