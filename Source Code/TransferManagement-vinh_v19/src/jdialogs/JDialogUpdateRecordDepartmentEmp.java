...
public class JDialogUpdateRecordDepartmentEmp extends JDialog {
	...
	public JDialogUpdateRecordDepartmentEmp(UpdateDepartmentEmpRepsone updateDepartmentEmpRepsone) {
		...
		}
		{
			...
			jButtonUpdateRecord.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					do_jButtonUpdateRecord_actionPerformed(e, updateDepartmentEmpRepsone);
				}
			});
			{
	 ...
	 */
	public JDialogUpdateRecordDepartmentEmp(UpdateDepartmentEmpRepsone updateDepartmentEmpRepsone, Map<String, Object> dataRecord, Map<String, Object> data) {
		this(updateDepartmentEmpRepsone);
...
//		}
	...
	protected void do_jButtonUpdateRecord_actionPerformed(ActionEvent e, UpdateDepartmentEmpRepsone updateDepartmentEmpRepsone) {
		EmployeeModel employeeModel = new EmployeeModel();
		DepartmentModel departmentModel = new DepartmentModel();
		...
		int departmentFromId = departmentModel.getDepartmentId(departmentFrom);
		
		String departmentTo = jtextFieldToDepartment.getText();
		int departmentToId = departmentModel.getDepartmentId(departmentTo);
		...
		record.setDepartmentFrom(departmentFromId);
		record.setDepartmentTo(departmentToId);
		try {
		...
		updateDepartmentEmpRepsone.getValue(record);
		dispose();
