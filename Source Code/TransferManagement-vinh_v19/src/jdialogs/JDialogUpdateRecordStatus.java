...
public class JDialogUpdateRecordStatus extends JDialog {
	 ...
	 */
	public JDialogUpdateRecordStatus(UpdateProjectRepsone updateProjectRepsone) {
		...
		}
		{
			...
			getContentPane().add(jcomboBoxRequestFor, gbc_jcomboBoxRequestFor);
		}
		{
		...
		}
		{
			...
			{
				JRadioButton jRadioButtonPending = new JRadioButton("Pending");
				jRadioButtonPending.setActionCommand("0");
				jbuttonGroupStatus.add(jRadioButtonPending);
				jpanelStatus.add(jRadioButtonPending);
			}
			{
				JRadioButton jRadioButtonApprove = new JRadioButton("Approve");
				jRadioButtonApprove.setActionCommand("1");
				jbuttonGroupStatus.add(jRadioButtonApprove);
				jpanelStatus.add(jRadioButtonApprove);
			}
			{
				JRadioButton jRadioButtonReject = new JRadioButton("Reject");
	...
	public JDialogUpdateRecordStatus(UpdateProjectRepsone updateProjectRepsone, Map<String, Object> dataRecord, Map<String, Object> data) {
...
//		jcomboBoxRequestFor.setSelectedItem(requestFor);
...
//		System.out.println("Project To: " + projectTo);
		jcomboBoxToProject.setSelectedItem(projectTo);
...
//		int status = Integer.parseInt(jbuttonGroupStatus.getSelection().getActionCommand());
	...
	protected void do_jButtonUpdateRecord_actionPerformed(ActionEvent e, UpdateProjectRepsone updateProjectRepsone) {
		...
		updateProjectRepsone.getValue(record);
		dispose();
